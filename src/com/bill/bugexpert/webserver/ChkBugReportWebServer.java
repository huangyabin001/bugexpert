 ...
 */
package com.bill.bugexpert.webserver;
...
import com.bill.bugexpert.webserver.engine.WebApp;
import com.bill.bugexpert.webserver.engine.WebServer;
import com.bill.bugexpert.webserver.engine.WebServerSocket;

/**
 * This class integrates the simple and generic web server core into
 * chkbugreport. It specifies how to load static data and how to execute java
 * code to produce dynamic pages (or to load/store data)
 */
public class ChkBugReportWebServer implements WebApp {
	...
	public void wsjs(Module mod, HTTPRequest req, HTTPResponse resp) {
		try {
			// resp.setBody(getClass().getResourceAsStream(PlatformUtil.ASSETS_ROOT +
