...
public class ProcessLink extends DocNode {
    ...
    public ProcessLink(BugExpertModule mod, int pid) {
        this(mod, pid, SHOW_ALL);
    }

    public ProcessLink(BugExpertModule mod, int pid, int flags) {
        this(mod, pid, flags, null);
    }

    public ProcessLink(BugExpertModule mod, int pid, String name) {
        this(mod, pid, SHOW_ALL, name);
    }

    public ProcessLink(BugExpertModule mod, int pid, int flags, String name) {
        mMod = mod;
        mPid = pid;
        mFlags = flags;
        mName = name;
