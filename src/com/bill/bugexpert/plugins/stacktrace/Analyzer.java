...
import com.bill.bugexpert.doc.Bold;
...
/* package */ final class Analyzer {
    ...
    public void analyze(BugExpertModule br, Processes processes) {
    ...
    private void colorize(Process p, StackTrace stack, BugExpertModule br) {
        if (stack == null)
            return;
    ...
    private void checkMainThreadViolation(StackTrace stack, Process p, BugExpertModule br, boolean isDirect) {
    ...
    private void checkDeadLock(Processes processes, BugExpertModule br) {
    ...
    private void listThreads(BugExpertModule br, DocNode msg, Vector<StackTrace> list, Vector<StackTrace> referenceList) {
