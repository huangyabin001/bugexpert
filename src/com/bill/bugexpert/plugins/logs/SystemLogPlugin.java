...
import com.bill.bugexpert.doc.Icon;
...
public class SystemLogPlugin extends LogPlugin {
    ...
    @Override
    protected void generateExtra(BugExpertModule br, Chapter ch) {
        generateLogLevelDistribution(br, ch);
    }

    private void generateLogLevelDistribution(BugExpertModule br, Chapter mainCh) {
    ...
    @Override
    protected void analyze(LogLine sl, int i, BugExpertModule br, Section s) {
    ...
    private void analyzeConfigChanged(LogLine sl, BugExpertModule br) {
        ConfigChange cc = new ConfigChange(sl.ts);
        addConfigChange(cc);
    }

    private void analyzeStartProc(LogLine sl, BugExpertModule br) {
    ...
    private void analyzeNativeCrash(LogLine sl, int i, BugExpertModule br, Section s) {
        // Put a marker box
    ...
    private void analyzeANR(LogLine sl, int i, BugExpertModule br, Section s) {
    ...
    private void analyzeHPROF(LogLine sl, int i, BugExpertModule br, Section s) {
        // Put a marker box
    ...
    private void analyzeFatalException(LogLine sl, int i, BugExpertModule br, Section s) {
        // Put a marker box
    ...
    private void analyzeJavaException(LogLine sl, int i, BugExpertModule br, Section s) {
        // Find the beginning
        int firstLine = i;
        while (true) {
    ...
    private void analyzeStrictMode(LogLine sl, int i, BugExpertModule br, Section s) {
        // Check previous line
        if (i > 0) {
    ...
    private void analyzeGC(LogLine sl, int i, BugExpertModule br, Section s) {
        String line = sl.line;
    ...
    private void analyzeRotation(LogLine sl, BugExpertModule br, int rot) {
        // Put a marker box
    ...
    private void analyzeDisplayed(LogLine sl, BugExpertModule br) {
        // Put a marker box
        String name = Util.extract(sl.msg, " ", ":");
        addActivityLaunchMarker(sl, name);
    }

    private void analyzeStartHome(LogLine sl, BugExpertModule br) {
        // Put a marker box
