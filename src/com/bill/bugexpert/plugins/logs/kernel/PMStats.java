...
/* package */ class PMStats {
    ...
    public PMStats(KernelLogData log, BugExpertModule br) {
        mLog = log;
        mId = log.getId();
    }
    ...
    public void generate(BugExpertModule br, Chapter mainCh) {
        genWakeupStat(br, mainCh);
        genSuspendAttempts(br, mainCh);
    }

    private void genSuspendAttempts(BugExpertModule br, Chapter mainCh) {
    ...
    public void genWakeupStat(BugExpertModule br, Chapter mainCh) {
