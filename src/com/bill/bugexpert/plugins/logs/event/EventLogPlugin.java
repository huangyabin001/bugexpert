 ...
 */
package com.bill.bugexpert.plugins.logs.event;
...
import com.bill.bugexpert.plugins.logs.ConfigChange;
import com.bill.bugexpert.plugins.logs.GCRecord;
...
public class EventLogPlugin extends LogPlugin {
    ...
    @Override
    protected void generateExtra(BugExpertModule rep, Chapter ch) {
    ...
    private void analyzeCrashOrANR(LogLine sl, int i, BugExpertModule br, String type) {
        // Put a marker box
...
//            int zygBytesAlloc = unFloat12(Util.bits(l2, 11, 0));
    ...
    private void addSampleData(Module br, String eventType, LogLine sl) {
        ...
        try {
            ...
            br.logE(TAG + "addSampleData(eventType=" + eventType + "):" + e);
        }
    }
    ...
    private void finishActivityLaunchTime(BugExpertModule br, Chapter ch) {
    ...
    private void finishDBStats(BugExpertModule br, Chapter ch) {
    ...
    private void writeDBStats(HashMap<String,DBStat> stats, String title, String id, BugExpertModule br, Chapter ch) {
    ...
    private Chapter saveDBFilteredLogs(BugExpertModule br, String fn, Vector<SampleData> data) {
