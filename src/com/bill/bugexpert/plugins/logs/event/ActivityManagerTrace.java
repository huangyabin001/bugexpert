...
public class ActivityManagerTrace {
    ...
    public void addAMData(String eventType, BugExpertModule br, LogLine sl, int i) {
        try {
            addAMDataUnsafe(eventType, br, sl, i);
        } catch (Exception e) {
            br.logE("Error parsing AM data from event log at line " + (i + 1) + " (" + e + ")");
        }
    }

    private void addAMDataUnsafe(String eventType, BugExpertModule br, LogLine sl, int i) {
    ...
    private void suggestName(BugExpertModule br, LogLine sl, int idxPid, int idxPkg, int prio) {
    ...
    private void suggestNameImpl(BugExpertModule br, LogLine sl, int pid, int idxPkg, int prio) {
