...
public class LogLine extends DocNode {
    ...
    public LogLine(BugExpertModule br, String line, int format, LogLine prev) {
        this.line = line;
        css = "log-debug";
        level = 'D';
     ...
     */
    private boolean parseFmtStd(BugExpertModule br, String line) {
     ...
     */
    private boolean parseFmtBrat(BugExpertModule br, String line) {
     ...
     */
    private boolean parseFmtShort(BugExpertModule br, String line, LogLine prev) {
