...
import com.bill.bugexpert.plugins.WindowManagerPlugin.WindowManagerState.Window;
...
public class WindowManagerPlugin extends Plugin {
    ...
    public void load(Module br) {
        ...
        if (mSection == null) {
            br.logE(TAG + "Section not found: " + Section.DUMP_OF_SERVICE_WINDOW + " (aborting plugin)");
            return;
        }
    ...
    private boolean loadEventHubState(Module br, DumpTree dump) {
        ...
        if (!foundDevices) {
            br.logE("Device list not found in event hub state");
            return false;
        }
    ...
    private boolean loadWindowManagerState(Module br, DumpTree dump) {
        ...
        if (root == null) {
            br.logE("Cannot find node '" + nodeKey1 + "' or '" + nodeKey2 + "'");
            return false;
        }
