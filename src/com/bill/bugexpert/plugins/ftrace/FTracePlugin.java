...
public class FTracePlugin extends Plugin {
    ...
    public void generate(Module rep) {
        ...
        if (ftrace == null) {
            br.logE(TAG + "Cannot find section: " + Section.FTRACE);
            return;
        }
    ...
    private DocNode makeProcName(BugExpertModule br, FTraceProcessRecord pr, boolean addLink) {
    ...
    private void addStatTblRow(BugExpertModule br, Table t, FTraceProcessRecord pr, long duration, boolean addLink) {
    ...
    private void addTraceTblRow(BugExpertModule br, Table t, FTraceProcessRecord pr, boolean addLink) {
        String png = "ftrace_" + pr.pid + ".png";
        t.addData(makeProcName(br, pr, addLink));
    ...
    private void createParallelHist(Chapter ch, BugExpertModule br, TraceRecord head, long duration, int w) {
        // Setup initial data
        int max = 16;
